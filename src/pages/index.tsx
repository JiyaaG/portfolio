    ...
    <Layout>
      <div className="content-container">
        ...
        <div className="welcome-text">
          ...
          <p>Curious how this came together? <a href="https://github.com/jiyaagidwani/portfolio" target="_blank" rel="noopener noreferrer" className="source-link">Peek at the source here</a>.</p>
        </div>
      </div>
    </Layout>
  );
